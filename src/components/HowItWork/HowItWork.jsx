                ...
                <div>
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 mt-8">
                        <div className="bg-blue-100 p-6 rounded-lg shadow-lg">
                            <h3 className="text-xl font-semibold text-blue-600">Step 1: Choose a Contest</h3>
                            <p>Browse through our available contests and pick the one that suits you best.</p>
                        </div>
                        <div className="bg-blue-100 p-6 rounded-lg shadow-lg">
                            <h3 className="text-xl font-semibold text-blue-600">Step 2: Submit Your Work</h3>
                            <p>Upload your article, poem, or essay by following the submission guidelines.</p>
                        </div>
                        <div className="bg-blue-100 p-6 rounded-lg shadow-lg">
                            <h3 className="text-xl font-semibold text-blue-600">Step 3: Win and Celebrate</h3>

    ...
    return (
        <div>
            <div className="min-h-screen bg-base-300 flex items-center justify-center p-4">
                <div className="w-full max-w-3xl bg-base-100 rounded-2xl shadow-2xl p-8">
                    ...
                    <form onSubmit={handleSubmit(handleUpdateProfile)} className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div className='flex items-center gap-5'>
                                <div>
                                    <input type="radio" {...register('gender', {required: "Gender is required"})} value='male' id='male' className="radio radio-primary mr-1" />
                                    <label htmlFor="male">Male</label>
                                </div>
                                <div>
                                    <input type="radio" {...register('gender')} value='female' id='female' className="radio radio-primary mr-1" />
